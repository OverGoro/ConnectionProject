...
import com.connection.message.MessageServiceImpl;
import com.connection.message.config.SecurityUtils;
import com.connection.message.kafka.*;
...
class MessageServiceImplTest {
    ...
    @Mock
    private TypedBufferKafkaClient bufferKafkaClient;

    @Mock
    private TypedConnectionSchemeKafkaClient connectionSchemeKafkaClient;

    @Mock
    private TypedDeviceAuthKafkaClient deviceAuthKafkaClient;
    ...
    void setUp() {
        ...
        messageService = new MessageServiceImpl(
            ...
            authKafkaClient,
            bufferKafkaClient,
            connectionSchemeKafkaClient,
            deviceAuthKafkaClient,
            deviceKafkaClient,
            bufferConverter,
    ...
    void testGetMessagesByScheme_WithClientAuthentication() {
        ...
        // securityUtilsMock.when(SecurityUtils::isClientAuthenticated).thenReturn(true);
        // securityUtilsMock.when(SecurityUtils::getCurrentClientUid).thenReturn(clientUid);
        // when(connectionSchemeKafkaClient.connectionSchemeExistsAndBelongsToClient(eq(schemeUid), eq(clientUid)))
        //     .thenReturn(true);
    ...
    void testGetMessagesByDevice_WithClientAuthentication() {
        ...
        // securityUtilsMock.when(SecurityUtils::isClientAuthenticated).thenReturn(true);
        // securityUtilsMock.when(SecurityUtils::getCurrentClientUid).thenReturn(clientUid);
        // when(deviceKafkaClient.deviceExistsAndBelongsToClient(eq(deviceUid), eq(clientUid)))
        //     .thenReturn(true);
