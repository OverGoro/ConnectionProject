...
// "connection-scheme.responses." + UUID.randomUUID().toString();
...
// public CompletableFuture<GetConnectionSchemeByUidResponse> getConnectionSchemeByUid(
...
// .correlationId(ConnectionSchemeEventUtils
// .generateCorrelationId())
// .build(),
// GetConnectionSchemeByUidResponse.class);
// }

// public CompletableFuture<GetConnectionSchemesByBufferResponse> getConnectionSchemesByBufferUid(
// UUID bufferUid, String sourceService) {
// return sendRequest(
// GetConnectionSchemesByBufferUid.builder().bufferUid(bufferUid)
// .sourceService(sourceService)
// .replyTopic(instanceReplyTopic)
// .correlationId(ConnectionSchemeEventUtils
// .generateCorrelationId())
...
// return sendRequest(
// HealthCheckCommand.builder().sourceService(sourceService)
// .replyTopic(instanceReplyTopic)
// .correlationId(ConnectionSchemeEventUtils
// .generateCorrelationId())
// .build(),
...
// public boolean connectionSchemeExistsAndBelongsToClient(
// UUID connectionSchemeUid) {
// try {
// GetConnectionSchemeByUidResponse response =
// getConnectionSchemeByUid(connectionSchemeUid,
// "message-service").get(10, TimeUnit.SECONDS);
// return response.isSuccess()
// && response.getConnectionSchemeDto() != null;
// } catch (Exception e) {
// log.error("Error checking connection scheme existence: {}",
// e.getMessage());
// return false;
// }
// }
...
// public boolean connectionSchemeExistsAndBelongsToClient(
// UUID connectionSchemeUid, UUID clientUuid) {
// try {
// GetConnectionSchemeByUidResponse response =
// getConnectionSchemeByUid(connectionSchemeUid,
// "message-service").get(10, TimeUnit.SECONDS);
// return response.isSuccess()
// && response.getConnectionSchemeDto() != null
// && response.getConnectionSchemeDto().getClientUid()
// .equals(clientUuid.toString());
// } catch (Exception e) {
// log.error("Error checking connection scheme existence: {}",
// e.getMessage());
// return false;
...
// log.warn(
// "Connection scheme request timeout or error for correlationId: {}",
// correlationId);
// }
// });
...
// pendingRequests.remove(correlationId);
// log.error(
// "Failed to send connection scheme command: {}",
// ex.getMessage());
// } else {
// log.info(
// "Connection scheme command sent successfully: correlationId={}, topic={}",
...
// log.info(
// "Connection scheme response handled successfully: correlationId={}",
// correlationId);
// } else {
// log.warn(
...
// "Type mismatch in connection scheme response"));
// }
// } catch (Exception e) {
...
// } else {
// log.warn(
// "Received connection scheme response for unknown correlationId: {}",
// correlationId);
// }
// }
...
// return ((GetConnectionSchemeByUidCommand) command)
// .getCorrelationId();
// } else if (command instanceof GetConnectionSchemesByBufferUid) {
// return ((GetConnectionSchemesByBufferUid) command)
// .getCorrelationId();
// } else if (command instanceof HealthCheckCommand) {
// return ((HealthCheckCommand) command).getCorrelationId();
// } else {
// throw new IllegalArgumentException(
// "Unsupported connection scheme command type: "
// + command.getClass());
// }
// }
