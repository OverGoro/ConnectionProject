...
// "buffer.responses." + UUID.randomUUID().toString();
...
// public CompletableFuture<GetBufferByUidResponse> getBufferByUid(
// UUID bufferUid, String sourceService) {
// return sendRequest(GetBufferByUidCommand.builder().bufferUid(bufferUid)
// .sourceService(sourceService).replyTopic(instanceReplyTopic)
// .correlationId(BufferEventUtils.generateCorrelationId())
// .build(), GetBufferByUidResponse.class);
// }

// public CompletableFuture<GetBuffersByClientResponse> getBuffersByClientUid(
// UUID clientUid, String sourceService) {
// return sendRequest(GetBuffersByClientUidCommand.builder()
// .clientUid(clientUid).sourceService(sourceService)
// .replyTopic(instanceReplyTopic)
// .correlationId(BufferEventUtils.generateCorrelationId())
// .build(), GetBuffersByClientResponse.class);
// }

// public CompletableFuture<GetBuffersByDeviceResponse> getBuffersByDeviceUid(
// UUID deviceUid, String sourceService) {
// return sendRequest(GetBuffersByDeviceUidCommand.builder()
// .deviceUid(deviceUid).sourceService(sourceService)
// .replyTopic(instanceReplyTopic)
// .correlationId(BufferEventUtils.generateCorrelationId())
// .build(), GetBuffersByDeviceResponse.class);
// }

// public CompletableFuture<GetBuffersByConnectionSchemeResponse> getBuffersByConnectionSchemeUid(
// UUID connectionSchemeUid, String sourceService) {
// return sendRequest(GetBuffersByConnectionSchemeUidCommand.builder()
// .connectionSchemeUid(connectionSchemeUid)
// .sourceService(sourceService).replyTopic(instanceReplyTopic)
// .correlationId(BufferEventUtils.generateCorrelationId())
// .build(), GetBuffersByConnectionSchemeResponse.class);
// }
...
// .sourceService(sourceService).timestamp(new Date().toInstant())
// .replyTopic(instanceReplyTopic)
// .correlationId(BufferEventUtils.generateCorrelationId())
// .commandType(BufferEventConstants.COMMAND_HEALTH_CHECK).build(),
...
// correlationId =
// ((GetBufferByUidCommand) command).getCorrelationId();
// } else if (command instanceof GetBuffersByClientUidCommand) {
// correlationId =
// ((GetBuffersByClientUidCommand) command).getCorrelationId();
// } else if (command instanceof GetBuffersByDeviceUidCommand) {
// correlationId =
// ((GetBuffersByDeviceUidCommand) command).getCorrelationId();
// } else if (command instanceof GetBuffersByConnectionSchemeUidCommand) {
// correlationId = ((GetBuffersByConnectionSchemeUidCommand) command)
// .getCorrelationId();
// } else if (command instanceof HealthCheckCommand) {
// correlationId = ((HealthCheckCommand) command).getCorrelationId();
// } else {
// throw new IllegalArgumentException(
// "Unsupported command type: " + command.getClass());
// }
...
// log.warn(
// "Buffer request timeout or error for correlationId: {}",
// correlationId);
// }
// });
...
// pendingRequests.remove(correlationId);
// log.error("Failed to send buffer command: {}",
// ex.getMessage());
// } else {
// log.info(
// "Buffer command sent successfully: correlationId={}, topic={}",
...
// log.info(
// "Buffer response handled successfully: correlationId={}",
// correlationId);
// } else {
// log.warn(
...
// "Type mismatch in buffer response"));
// }
// } catch (Exception e) {
// pendingRequest.future.completeExceptionally(e);
// }
// } else {
// log.warn("Received buffer response for unknown correlationId: {}",
// correlationId);
// }
// }
