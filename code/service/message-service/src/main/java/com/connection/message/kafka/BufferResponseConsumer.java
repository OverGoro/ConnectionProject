...
// @KafkaListener(id = 
// "dynamicBufferListener", topics = "#{@typedBufferKafkaClient.getInstanceReplyTopic()}")
...
// GetBuffersByConnectionSchemeResponse 
// typedResponse = (GetBuffersByConnectionSchemeResponse) message;
// bufferKafkaClient.handleResponse(correlationId, typedResponse);
