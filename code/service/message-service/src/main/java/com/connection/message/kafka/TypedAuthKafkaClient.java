    ...
    // "auth.responses." + UUID.randomUUID().toString();
    ...
    // public CompletableFuture<TokenValidationResponse> validateToken(
    // String token, String sourceService) {
    // return sendRequest(ValidateTokenCommand.builder().token(token)
    // .tokenType(ValidateTokenCommand.TokenType.ACCESS)
    // .sourceService(sourceService).replyTopic(instanceReplyTopic)
    // .correlationId(AuthEventUtils.generateCorrelationId()).build(),
    // TokenValidationResponse.class);
    // }

    // public CompletableFuture<ClientUidResponse> getClientUid(String token,
    // String sourceService) {
    // return sendRequest(ExtractClientUidCommand.builder().token(token)
    ...
    // .commandType(AuthEventConstants.COMMAND_HEALTH_CHECK).build(),
    ...
    // correlationId =
    // ((ExtractClientUidCommand) command).getCorrelationId();
    ...
    // log.warn("Auth request timeout or error for correlationId: {}",
    // correlationId);
    // }
    // });
    ...
    // pendingRequests.remove(correlationId);
    // log.error("Failed to send auth command: {}",
    // ex.getMessage());
    // } else {
    // log.info(
    // "Auth command sent successfully: correlationId={}, topic={}",
    ...
    // log.info(
    // "Auth response handled successfully: correlationId={}",
    // correlationId);
    // } else {
    // log.warn(
    ...
    // "Type mismatch in auth response"));
    // }
    // } catch (Exception e) {
    // pendingRequest.future.completeExceptionally(e);
    // }
    // } else {
    // log.warn("Received auth response for unknown correlationId: {}",
    // correlationId);
    // }
    // }
