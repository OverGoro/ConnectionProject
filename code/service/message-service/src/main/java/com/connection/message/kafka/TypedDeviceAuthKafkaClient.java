...
// "device.auth.responses." + UUID.randomUUID().toString();
...
// .build(), TokenValidationResponse.class);
// }

// public CompletableFuture<TokenValidationResponse> validateDeviceToken(
// String token, String sourceService) {
// return sendRequest(ValidateTokenCommand.builder().token(token)
// .tokenType(ValidateTokenCommand.TokenType.ACCESS)
// .sourceService(sourceService).replyTopic(instanceReplyTopic)
...
// public CompletableFuture<DeviceUidResponse> getDeviceUid(String token,
// String sourceService) {
// return sendRequest(ExtractDeviceUidCommand.builder().token(token)
// .tokenType(ExtractDeviceUidCommand.TokenType.ACCESS)
// .sourceService(sourceService).replyTopic(instanceReplyTopic)
// .correlationId(DeviceAuthEventUtils.generateCorrelationId())
// .build(), DeviceUidResponse.class);
// }

// public CompletableFuture<DeviceUidResponse> getDeviceUidFromDeviceToken(
// String token, String sourceService) {
// return sendRequest(ExtractDeviceUidCommand.builder().token(token)
// .tokenType(ExtractDeviceUidCommand.TokenType.ACCESS)
// .sourceService(sourceService).replyTopic(instanceReplyTopic)
...
// correlationId =
// ((ExtractDeviceUidCommand) command).getCorrelationId();
...
// log.error("Failed to send device auth command: {}",
// ex.getMessage());
// }
// });
...
// "Type mismatch in device auth response"));
// }
// } catch (Exception e) {
...
// } else {
// log.warn(
// "Received device auth response for unknown correlationId: {}",
// correlationId);
// }
// }
