package com.connection.device.config.kafka;
...
// "com.connection.auth.events.commands,com.connection.common.
// events,com.connection.device.events.commands,com.connection.auth.events.responses");
...
// "com.connection.common.events.Command");
...
// new DefaultErrorHandler((record, exception) -> { // Логируем ошибку с помощью SLF4J
// org.slf4j.Logger logger = org.slf4j.LoggerFactory
// .getLogger("KafkaErrorHandler");
// logger.error(
