package com.service.device.auth.config.kafka;
...
// Object> factory = new ConcurrentKafkaListenerContainerFactory<>();
// factory.setConsumerFactory(consumerFactory());

// DefaultErrorHandler errorHandler = new DefaultErrorHandler(
// (record, exception) -> {
// org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger("DeviceAuthKafkaErrorHandler");
// logger.error("Skipping invalid device auth message - 
