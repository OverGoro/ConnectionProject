...
public class DeviceAuthGlobalExceptionHandler {
    /** . */
    ...
    public ResponseEntity<?> handleDeviceAlreadyExistsException(
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(new ErrorResponse("device_already_exist",
    ...
    public ResponseEntity<?> handleDeviceNotFoundException(
            com.connection.device.exception.DeviceNotFoundException e) {
        log.warn("Device not found: {}", e.getMessage());
        return ResponseEntity.status(HttpStatus.NOT_FOUND)
                .body(new ErrorResponse("device_not_found", "User not found"));
    }

    /** . */
    @ExceptionHandler(com.connection.device.exception.DeviceValidateException.class)
    public ResponseEntity<?> handleDeviceValidateException(
            com.connection.device.exception.DeviceValidateException e) {
    ...
    public ResponseEntity<?> handeleDeviceTokenException(
            com.connection.device.token.exception.DeviceTokenAlreadyExistsException e) {
        log.warn("Device token adding failed: {}", e.getMessage());
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(new ErrorResponse("device_token_already_exist",
    ...
    public ResponseEntity<?> handeleDeviceTokenException(
            com.connection.device.token.exception.DeviceTokenNotFoundException e) {
        log.warn("Device token getting failed: {}", e.getMessage());
        return ResponseEntity.status(HttpStatus.NOT_FOUND)
                .body(new ErrorResponse("device_token_not_found",
                        "No such token exist"));
    }
    ...
    public ResponseEntity<?> handeleDeviceTokenException(
            com.connection.device.token.exception.DeviceTokenValidateException e) {
        log.warn("Device token getting failed: {}", e.getMessage());
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(
                new ErrorResponse("device_token_invalid", "Invalid token"));
    }
    ...
    public ResponseEntity<?> handeleDeviceTokenException(
            com.connection.device.token.exception.DeviceAccessTokenExistsException e) {
        log.warn("Device access token adding failed: {}", e.getMessage());
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(new ErrorResponse("device_access_token_already_exist",
    ...
    /** . */
    @ExceptionHandler(
        com.connection.device.token.exception.DeviceAccessTokenNotFoundException.class)
    public ResponseEntity<?> handeleDeviceTokenException(
            com.connection.device.token.exception.DeviceAccessTokenNotFoundException e) {
        log.warn("Device access token getting failed: {}", e.getMessage());
        return ResponseEntity.status(HttpStatus.NOT_FOUND)
                .body(new ErrorResponse("device_access_token_not_found",
                        "No such access token exist"));
    }

    /** . */
    @ExceptionHandler(
        com.connection.device.token.exception.DeviceAccessTokenValidateException.class)
    public ResponseEntity<?> handeleDeviceTokenException(
            com.connection.device.token.exception.DeviceAccessTokenValidateException e) {
        log.warn("Device token getting failed: {}", e.getMessage());
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(new ErrorResponse("device_access_token_invalid",
                        "Invalid access token"));
    }

    /** . */
    @ExceptionHandler(io.jsonwebtoken.JwtException.class)
    public ResponseEntity<?> handeleJwtException(
            io.jsonwebtoken.JwtException e) {
        log.warn("JWT token invalid: {}", e.getMessage());
        return ResponseEntity.status(HttpStatus.FORBIDDEN).body(
                new ErrorResponse("jwt_token_invalid", "Invalid jwt token"));
    }
    ...
    public ResponseEntity<?> handeleJwtException(IllegalArgumentException e) {
        log.warn("JWT token invalid: {}", e.getMessage());
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(
                new ErrorResponse("illegal_argument", "Illegal argument"));
    }
