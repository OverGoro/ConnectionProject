...
@ComponentScan(
        basePackages = {"com.connection.gateway", "com.connection.service.auth",
            "com.service.device.auth", "com.connection.device",
            "com.connection.message", "com.service.buffer",
        ...
        excludeFilters = {
            ...
            @ComponentScan.Filter(type = FilterType.REGEX,
                pattern = {"com.connection.service.auth.config.kafka.*",
            ...
            @ComponentScan.Filter(type = FilterType.REGEX,
                    pattern = {"com.connection.service.auth.config.security.*",
            ...
            @ComponentScan.Filter(type = FilterType.REGEX,
                    pattern = {"com.connection.service.auth.config.spring.*",
            ...
            @ComponentScan.Filter(type = FilterType.REGEX,
                    pattern = {"com.connection.service.auth.config.swagger.*",
            ...
            @ComponentScan.Filter(type = FilterType.REGEX,
                    pattern = {"com.connection.service.auth.config.transaction.*",
            ...
            @ComponentScan.Filter(type = FilterType.REGEX,
                    pattern = {"com.connection.service.auth.*Filter.*",
