...
// private final String instanceReplyTopic = "c
// onnection-scheme.responses." + UUID.randomUUID().toString();
...
// public CompletableFuture<GetConnectionSchemeByUidRespon
// se> getConnectionSchemeByUid(UUID connectionSchemeUid, String sourceService) {
// return sendRequest(
...
// public boolean connectionSchemeExistsAndBelongsToCl
// ient(UUID connectionSchemeUid, UUID clientUuid) {
// try {
// GetConnectionSchemeByUidResponse response = getConnecti
// onSchemeByUid(connectionSchemeUid, "buffer-service")
...
// connection scheme command type: " + command.getClass());
// }
// }
