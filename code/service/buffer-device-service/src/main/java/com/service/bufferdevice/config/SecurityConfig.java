...
import com.service.bufferdevice.client.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(authz -> authz
                ...
                .requestMatchers("/api/buffer-device-service/health").permitAll()
                .requestMatchers("/api/buffer-device-service/**").permitAll()//.authenticated()
