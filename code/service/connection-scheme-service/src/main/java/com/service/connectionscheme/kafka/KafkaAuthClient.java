...
// public class KafkaAuthClient implements AuthService{
...
//     private CompletableFuture<TokenValidationResponse> validateToken(String token, String sourceService) {
//         return sendRequest(
...
//     private CompletableFuture<ClientUidResponse> getClientUid(String token, String sourceService) {
//         return sendRequest(
...
//     private CompletableFuture<HealthCheckResponse> healthCheck(String sourceService) {
//         return sendRequest(
...
//     private void handleResponse(String correlationId, Object response) {
...
//     private String getInstanceReplyTopic() {
