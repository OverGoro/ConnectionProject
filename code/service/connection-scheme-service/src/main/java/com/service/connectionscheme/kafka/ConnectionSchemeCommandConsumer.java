    ...
    // log.info("Received connection scheme command: {} wi
    // th key: {}", command.getClass().getSimpleName(), key);
    ...
    // GetConnectionSchemesByClientUid getSchemesCommand 
    // = (GetConnectionSchemesByClientUid) command;
    ...
    // GetConnectionSchemesByBufferUid getSchemesCommand
    //  = (GetConnectionSchemesByBufferUid) command;
    ...
    // } else {
    // log.warn("Unknown connection scheme command type: {}", 
    ...
    // private void handleGetConnectionSchemeByUidCommand(GetConne
    // ctionSchemeByUidCommand command, String key) {
    // try {
    // log.info("Processing GetConnectionSchemeByUidCommand for
    //  scheme UID: {}", command.getConnectionSchemeUid());

    // ConnectionSchemeBlm schemeBlm = connectionSchemeService.g
    // etSchemeByUid(command.getConnectionSchemeUid());
    ...
    // } catch (Exception e) {
    // log.error("Error processing GetConnectionSchemeByUidCommand for sc
    // heme UID: {}", command.getConnectionSchemeUid(), e);
    ...
    // private void handleGetConnectionSchemesByClientCommand(GetConnecti
    // onSchemesByClientUid command, String key) {
    // try {
    // log.info("Processing GetConnectionSchemesByClientCommand for clie
    // nt UID: {}", command.getClientUid());

    // List<ConnectionSchemeBlm> schemesBlm = connectionSchemeService.getSc
    // hemesByClient(command.getClientUid());
    ...
    // } catch (Exception e) {
    // log.error("Error processing GetConnectionSchemesByClientCommand for cl
    // ient UID: {}", command.getClientUid(), e);
    ...
    // private void handleGetConnectionSchemesByBufferUidCommand(GetConnectio
    // nSchemesByBufferUid command, String key) {
    // try {
    // log.info("Processing GetConnectionSchemesByBufferCommand for Buffer 
    // UID: {}", command.getBufferUid());

    // List<ConnectionSchemeBlm> schemesBlm = connectionSchemeService.getSche
    // mesByBuffer(command.getBufferUid());
    // List<ConnectionSchemeDto> schemeDtos = schemesBlm.stream()
    // .map(connectionSchemeConverter::toDto)
    // .collect(Collectors.toList());
    ...
    // } catch (Exception e) {
    // log.error("Error processing GetConnectionSchemesByBufferCo
    // mmand for Buffer UID: {}", command.getBufferUid(), e);
