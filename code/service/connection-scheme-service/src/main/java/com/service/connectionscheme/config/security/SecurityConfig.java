...
package com.service.connectionscheme.config.security;

import com.service.connectionscheme.client.AuthenticationFilter;
...
public class SecurityConfig {
    ...
    @Qualifier("connectionSchemeAuthenticationFilter")
