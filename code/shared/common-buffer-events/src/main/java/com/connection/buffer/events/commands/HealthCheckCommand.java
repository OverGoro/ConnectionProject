...
public class HealthCheckCommand extends Command {
    ...
    public HealthCheckCommand() {
        super(BufferEventConstants.COMMAND_HEALTH_CHECK, "unknown",
                BufferEventConstants.BUFFER_COMMANDS_TOPIC);
    }

    /** . */
    public HealthCheckCommand(String sourceService) {
        super(BufferEventConstants.COMMAND_HEALTH_CHECK, sourceService,
                BufferEventConstants.BUFFER_COMMANDS_TOPIC);
    }
}
