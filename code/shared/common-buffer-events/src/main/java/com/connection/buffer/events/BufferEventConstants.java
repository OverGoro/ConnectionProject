...
public class BufferEventConstants {
    ...
    public static final String COMMAND_GET_BUFFERS_BY_CLIENT_UID =
            "GET_BUFFERS_BY_CLIENT_UID";
    public static final String COMMAND_GET_BUFFERS_BY_DEVICE_UID =
            "GET_BUFFERS_BY_DEVICE_UID";
    public static final String COMMAND_GET_BUFFERS_BY_CONNECTION_SCHEME_UID =
            "GET_BUFFERS_BY_CONNECTION_SCHEME_UID";
