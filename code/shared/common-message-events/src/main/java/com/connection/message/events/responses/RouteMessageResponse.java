...
public class RouteMessageResponse extends CommandResponse {
    ...
    /** . */
    public static RouteMessageResponse success(String correlationId,
            List<UUID> routedMessageUids) {
    ...
    /** . */
    public static RouteMessageResponse error(String correlationId,
            String error) {
        return RouteMessageResponse.builder()
                .eventId(UUID.randomUUID().toString())
