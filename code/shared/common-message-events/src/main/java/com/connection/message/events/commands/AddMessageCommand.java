...
public class AddMessageCommand extends Command {
    ...
    public AddMessageCommand() {
        super(MessageEventConstants.COMMAND_ADD_MESSAGE, "unknown",
                MessageEventConstants.MESSAGE_RESPONSES_TOPIC);
    }

    /** . */
    public AddMessageCommand(UUID deviceUid, String content, String contentType,
            String sourceService) {
        super(MessageEventConstants.COMMAND_ADD_MESSAGE, sourceService,
                MessageEventConstants.MESSAGE_RESPONSES_TOPIC);
