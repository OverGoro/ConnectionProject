...
public class DeviceTokenObjectMother {
    ...
    private static final UUID DEFAULT_DEVICE_TOKEN_UID =
    ...
    public static DeviceTokenDto createValidDeviceTokenDto() {
        return DeviceTokenDto.builder().token(DEFAULT_TOKEN).build();
    }

    /** . */
    public static DeviceTokenBlm createValidDeviceTokenBlm() {
        return DeviceTokenBlm.builder().token(DEFAULT_TOKEN).uid(DEFAULT_UID)
                .deviceUid(DEFAULT_DEVICE_UID).createdAt(DEFAULT_CREATED_AT)
                .expiresAt(DEFAULT_EXPIRES_AT).build();
    }

    /** . */
    public static DeviceTokenDalm createValidDeviceTokenDalm() {
        return DeviceTokenDalm.builder().uid(DEFAULT_UID)
                .deviceUid(DEFAULT_DEVICE_UID).token(DEFAULT_TOKEN)
                .createdAt(DEFAULT_CREATED_AT).expiresAt(DEFAULT_EXPIRES_AT)
                .build();
    }

    /** . */
    public static DeviceTokenDto createDeviceTokenDtoWithEmptyToken() {
        return DeviceTokenDto.builder().token("").build();
    }
    ...
    public static DeviceAccessTokenDto createValidDeviceAccessTokenDto() {
        return DeviceAccessTokenDto.builder().token(DEFAULT_TOKEN).build();
    }

    /** . */
    public static DeviceAccessTokenBlm createValidDeviceAccessTokenBlm() {
        return DeviceAccessTokenBlm.builder().token(DEFAULT_TOKEN)
                .uid(DEFAULT_UID).deviceTokenUid(DEFAULT_DEVICE_TOKEN_UID)
                .createdAt(DEFAULT_CREATED_AT).expiresAt(DEFAULT_EXPIRES_AT)
                .build();
    }
    ...
    public static DeviceAccessTokenDalm createValidDeviceAccessTokenDalm() {
        return DeviceAccessTokenDalm.builder().uid(DEFAULT_UID)
                .deviceTokenUid(DEFAULT_DEVICE_TOKEN_UID).token(DEFAULT_TOKEN)
                .createdAt(DEFAULT_CREATED_AT).expiresAt(DEFAULT_EXPIRES_AT)
                .build();
    }
    ...
    public static DeviceAccessTokenDto createDeviceAccessTokenDtoWithLongToken() {
        return DeviceAccessTokenDto.builder().token("a".repeat(513)).build();
    }
    ...
    public static DeviceTokenDalm createDeviceTokenForDevice(UUID deviceUid) {
        return DeviceTokenDalm.builder().uid(UUID.randomUUID())
                .deviceUid(deviceUid).token("token_for_" + deviceUid)
                .createdAt(DEFAULT_CREATED_AT).expiresAt(DEFAULT_EXPIRES_AT)
                .build();
    }

    /** . */
    public static DeviceAccessTokenDalm createDeviceAccessTokenForDeviceToken(
            UUID deviceTokenUid) {
        return DeviceAccessTokenDalm.builder().uid(UUID.randomUUID())
