...
package com.connection.processing.connection.scheme.validator;

import java.util.UUID;

import com.connection.processing.connection.scheme.exception.ConnectionSchemeValidateException;
